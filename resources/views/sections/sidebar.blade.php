             ...
             <ul>
                ...
                @if (
                    ...
                    <x-menu-item icon="people" :text="__('app.menu.hr')">
                        ...
                        @endif
                        @if (in_array('employees', user_modules()) && $sidebarUserPermissions['view_employees'] != 5 && $sidebarUserPermissions['view_employees'] != 'none')
                            <x-sub-menu-item :link="route('resource.index')" :text="__('app.menu.rscManagement')" />
                        @endif
                ...
                <!-- NAV ITEM - HR ADMIN MENU -->
                @if (
                    (in_array('client', user_roles()))
                    && (in_array('resource', user_modules()))
                 )
                    ...
                    <x-menu-item icon="people" :text="__('app.menu.hr')">
                        ...
                        <div class="accordionItemContent pb-2">
                            @if (in_array('resource', user_modules()))
                                <x-sub-menu-item :link="route('resource.index')" :text="__('app.menu.rscManagement')" />
                            @endif
                        </div>
                    </x-menu-item>
                ...
                @if (in_array('reports', user_modules()) &&
                        (
                            ...
                            || $sidebarUserPermissions['view_task_report'] == 2
                    ...
                    <x-menu-item icon="graph-up" :text="__('app.menu.reports')">
                        <x-slot name="iconPath">
                         ...
                         <div class="accordionItemContent pb-2">
                            @if (($sidebarUserPermissions['view_task_report'] == 4 || $sidebarUserPermissions['view_task_report'] == 2) && $sidebarUserPermissions['view_task_report'] != 'none' && in_array('tasks', user_modules()))
