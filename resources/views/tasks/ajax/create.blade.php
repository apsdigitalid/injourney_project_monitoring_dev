            ...
            <div class="add-client bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        @else
                            <x-forms.select fieldId="project_id" fieldName="project_id" fieldRequired="true" :fieldLabel="__('app.project')"
                                search="true">
                                <option value="">--</option>
                ...
                <div class="row p-20 d-none" id="other-details">
                    ...
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <x-forms.text :fieldLabel="__('modules.tasks.bobot')" fieldName="bobot" fieldRequired="false"
                                    fieldId="bobot" :fieldPlaceholder="__('placeholders.bobot')" />
                            </div>
                        </div>
                    </div>
