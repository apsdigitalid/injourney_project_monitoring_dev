...
class TasksDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->rawColumns(['board_column', 'action', 'project_name', 'weight','clientName', 'due_date', 'users', 'heading', 'check', 'timeLogged'])
    ...
    public function query(Task $model)
    {
        ...
        // ->select('*', DB::raw("CONCAT('100','') AS weight"))
        $model = $model->leftJoin('projects', 'projects.id', '=', 'tasks.project_id')
            ...
            ->selectRaw('tasks.id, tasks.added_by, projects.project_name, CONCAT(tasks.weight, "%") AS weight, tasks.heading, client.name as clientName, creator_user.name as created_by, creator_user.image as created_image, tasks.board_column_id,
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.weight')  => ['data' => 'weight', 'name' => 'weight', 'title' => 'Weight'],
