...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::get('resource', [EmployeeController::class, 'rscMgt'])->name('resource.index');
    Route::get('resource/{id}', [EmployeeController::class, 'rscMgt_show'])->name('resource.show');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('get-project-information', [ProjectController::class, 'getProjectInformation'])->name('projects.get_project_information');
            Route::post('get-project-information-task-total', [ProjectController::class, 'getProjectInformationTaskTotal'])->name('projects.get_information_project_task_total');
